...
ANSI_SEQUENCES.set("|!X", ANSI.BLACK);
ANSI_SEQUENCES.set("|!R", ANSI.RED);
ANSI_SEQUENCES.set("|!G", ANSI.GREEN);
ANSI_SEQUENCES.set("|!Y", ANSI.YELLOW);
ANSI_SEQUENCES.set("|!B", ANSI.BLUE);
ANSI_SEQUENCES.set("|!M", ANSI.MAGENTA);
ANSI_SEQUENCES.set("|!C", ANSI.CYAN);
ANSI_SEQUENCES.set("|!W", ANSI.WHITE);
